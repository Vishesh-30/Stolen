    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 class="mb-6 text-sm text-coolGray-500 hover:text-coolGray-900 font-bold">Legal</h2>
                  <ul class="text-coolGray-500 hover:text-coolGray-900 font-medium">
                      <li class="mb-4">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-coolGray-500 hover:text-coolGray-900 font-medium">© 2024 <a href="" class="hover:underline">Stolen Project™</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a href="#" class="text-gray-700 hover:text-green-500 hover:text-green ms-5">
