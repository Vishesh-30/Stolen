                ...
                <div class="flex justify-between items-center w-full">
                    ...
                    <div class="hidden xl:block xl:w-1/4">
                        ...
                        <ul class="flex justify-center items-center">
                            ...
                            <i class="fa-solid fa-wallet text-2xl text-green-900 pt-0.5 hover:text-green-700 focus:text-green-700 transition duration-300 ease-in-out"></i>
                            </li>
                            <li class="mr-10 cursor-pointer">
                            ...
                            <i class="fa-regular fa-circle-user text-3xl text-green-900 hover:text-green-700 focus:text-green-700 transition duration-300 ease-in-out"></i>
                            <ul v-if="dropdownOpen" class="absolute right-0 mt-2 w-96 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                                <li class="px-4 py-2 pt-8 bg-green-100 cursor-pointer h-20 items-center text-xl transition duration-300 ease-in-out"><i class="fa-regular fa-circle-user mr-3 text-xl"></i>{{ username }}</li>
                                <li class="px-4 py-2 hover:bg-green-100 cursor-pointer transition duration-300 ease-in-out">Settings</li>
                                <a @click="logout"><li class="px-4 py-2 hover:bg-green-100 cursor-pointer transition duration-300 ease-in-out"><i class="fa-solid fa-arrow-right-from-bracket mr-3"></i>Logout</li></a>
                            </ul>
                            </li>
                        </ul>
                        </div>
