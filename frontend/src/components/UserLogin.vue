      ...
      <div class="container mx-auto px-6 py-12 text-left">
        ...
        <div class="container mx-auto px-6 mt-5 py-12 text-left shadow-md bg-white rounded-lg h-auto w-1/2">
          ...
          <form @submit.prevent="submitForm" class="mt-8 space-y-6">
            ...
            <div v-if="error" class="text-green-600 text-center text-sm text-center" id="error">
            ...
            <div class="flex items-center justify-between mt-4">
              ...
              <div class="text-sm">
                <a href="#" class="font-medium text-green-600 hover:text-green-500 align">
          ...
          <p class="mt-2 text-sm pt-8 text-gray-500">By Logging In, you agree to the <a href="#" class="font-medium text-gray-900 hover:text-gray-600">Terms of Service</a> and <a href="#" class="font-medium text-gray-900 hover:text-gray-600">Privacy Policy</a>.</p>
        </div>
      </div>
      <LandingFooter />
    </div>
